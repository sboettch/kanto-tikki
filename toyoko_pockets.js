...
const POCKETS = [
  { id:'daikanyama-ty', st:'daikanyama', en:'Daikanyama', ja:'代官山',
    ...
    noiseWatch:null,
    axes:{ quiet:3, old:2, intl:4, food:4, dining:4, craft:3, green:3, photo:4, night:3 },
  ...
  { id:'nakameguro-ty', st:'nakameguro', en:'Nakameguro Canal', ja:'中目黒',
    ...
    axes:{ quiet:2, old:2, intl:4, food:5, dining:4, craft:3, green:3, photo:5, night:4 },
  ...
  { id:'jiyugaoka-ty', st:'jiyugaoka', en:'Jiyugaoka', ja:'自由が丘',
    ...
    noiseWatch:null,
    axes:{ quiet:2, old:2, intl:3, food:5, dining:4, craft:3, green:3, photo:4, night:2 },
  ...
  { id:'denencho-ty', st:'denencho', en:'Den-en-chofu', ja:'田園調布',
    ...
    noiseWatch:null,
    axes:{ quiet:5, old:4, intl:2, food:2, dining:3, craft:2, green:5, photo:4, night:1 },
  ...
  { id:'musashikosugi-ty', st:'musashikosugi', en:'Musashi-Kosugi', ja:'武蔵小杉',
    ...
    axes:{ quiet:2, old:1, intl:4, food:4, dining:3, craft:2, green:2, photo:2, night:3 },
  ...
  { id:'hiyoshi-ty', st:'hiyoshi', en:'Hiyoshi', ja:'日吉',
    ...
    noiseWatch:null,
    axes:{ quiet:3, old:2, intl:2, food:3, dining:2, craft:2, green:3, photo:2, night:2 },
  ...
  { id:'motomachi-ty', st:'motomachi', en:'Motomachi-Yamate', ja:'元町・山手',
    ...
    axes:{ quiet:3, old:5, intl:5, food:5, dining:4, craft:3, green:4, photo:5, night:2 },
...
const PKQ = [
  { q:{en:'Quiet back street or busy main street?',ja:'静かな裏道 or 賑やかな幹線道路？'}, axes:{ quiet:[1,0] } },
  { q:{en:'Old neighborhood feel or new construction?',ja:'昔ながらの雰囲気 or 新築？'}, axes:{ old:[1,0] } },
  { q:{en:'International vibe or local Japanese?',ja:'インターナショナルな雰囲気 or 地元の日本らしさ？'}, axes:{ intl:[1,0] } },
  { q:{en:'Lots of cafes and restaurants or basic daily shopping?',ja:'カフェ・飲食店が多い or 日用品中心？'}, axes:{ food:[1,0] } },
  { q:{en:'Weekend brunch district or every-day convenience?',ja:'週末のブランチスポット or 毎日使いの便利さ？'}, axes:{ dining:[1,0] } },
  { q:{en:'Green parks and trees or central density?',ja:'緑と公園 or 都心の密度？'}, axes:{ green:[1,0] } },
  { q:{en:'Photogenic streetscape or functional and plain?',ja:'フォトジェニックな街並み or 実用的でシンプル？'}, axes:{ photo:[1,0] } },
  { q:{en:'Night out options nearby or early to bed?',ja:'夜遊びの選択肢あり or 早寝の街？'}, axes:{ night:[1,0] } },
];
