...
const POCKETS = [
  { id:'shimokitazawa-od', st:'shimokitazawa', en:'Shimokitazawa', ja:'下北沢',
    ...
    axes:{quiet:2,old:3,intl:3,food:5,dining:3,craft:5,green:2,photo:4,night:4},
  ...
  { id:'seijogakuinmae-od', st:'seijogakuinmae', en:'Seijo', ja:'成城',
    ...
    noiseWatch:null,
    axes:{quiet:5,old:3,intl:2,food:3,dining:4,craft:2,green:5,photo:3,night:1},
  ...
  { id:'komae-od', st:'komae', en:'Komae', ja:'狛江',
    ...
    noiseWatch:null,
    axes:{quiet:4,old:2,intl:1,food:3,dining:2,craft:2,green:4,photo:2,night:2},
  ...
  { id:'gotokuji-od', st:'gotokuji', en:'Gotokuji', ja:'豪徳寺',
    ...
    noiseWatch:null,
    axes:{quiet:4,old:5,intl:1,food:3,dining:2,craft:3,green:3,photo:4,night:1},
    access:{en:'Gotokuji, Odakyu main line. Tokyu Setagaya tram nearby.',ja:'豪徳寺駅（小田急線）。東急世田谷線が近い。'} },
];
const PKQ = [
  { q:{en:'Quiet residential or lively station area?',ja:'静かな住宅地 or 活気ある駅前？'}, axes:{quiet:[1,0]} },
  { q:{en:'Old-town character or modern and new?',ja:'昔ながらの雰囲気 or 新しくモダン？'}, axes:{old:[1,0]} },
  { q:{en:'International feel or local and Japanese?',ja:'国際的な雰囲気 or 地元らしさ？'}, axes:{intl:[1,0]} },
  { q:{en:'Good restaurants and cafes or everyday essentials?',ja:'飲食店・カフェ充実 or 日用品重視？'}, axes:{food:[1,0]} },
  { q:{en:'Dining out options or cooking at home?',ja:'外食派 or 自炊派？'}, axes:{dining:[1,0]} },
  { q:{en:'Nearby parks or central city density?',ja:'公園・緑 or 都心の密度？'}, axes:{green:[1,0]} },
  { q:{en:'Interesting streetscape or plain and practical?',ja:'個性的な街並み or シンプルで実用的？'}, axes:{photo:[1,0]} },
  { q:{en:'Things to do at night or quiet evenings?',ja:'夜の選択肢 or 静かな夜？'}, axes:{night:[1,0]} },
];
