...
const POCKETS = [
  { id:'hiroo-hb', st:'hiroo', en:'Hiroo', ja:'広尾',
    ...
    noiseWatch:null,
    ax:{ quiet:4, old:2, intl:5, food:4, refined:5, craft:2, green:3, photo:3, night:2 },
  ...
  { id:'roppongi-hb', st:'roppongi', en:'Roppongi', ja:'六本木',
    ...
    ax:{ quiet:1, old:1, intl:5, food:4, refined:5, craft:3, green:2, photo:4, night:5 },
  ...
  { id:'ningyocho-hb', st:'ningyocho', en:'Ningyocho', ja:'人形町',
    ...
    noiseWatch:null,
    ax:{ quiet:3, old:5, intl:2, food:4, refined:3, craft:4, green:2, photo:4, night:2 },
  ...
  { id:'ueno-hb', st:'ueno', en:'Ueno', ja:'上野',
    ...
    ax:{ quiet:2, old:4, intl:3, food:4, refined:3, craft:3, green:4, photo:4, night:3 },
  ...
  { id:'kitasenju-hb', st:'kitasenju', en:'Kita-Senju', ja:'北千住',
    ...
    ax:{ quiet:2, old:3, intl:2, food:4, refined:3, craft:3, green:2, photo:3, night:3 },
    access:{en:'Kita-Senju, Hibiya Line + JR Joban + Tobu Skytree + Tsukuba Express.',ja:'北千住駅（日比谷線・JR常磐線・東武スカイツリー線・つくばエクスプレス）。'} },
];
const PKQ = [
  { q:{en:'Quiet street or busy area?',ja:'静かな街 or 賑やかなエリア？'}, ax:{ quiet:[1,0] } },
  { q:{en:'Old Edo character or modern city feel?',ja:'江戸の面影 or 現代都市の雰囲気？'}, ax:{ old:[1,0] } },
  { q:{en:'International neighbourhood or local Japanese?',ja:'国際的な街 or 地元の日本らしさ？'}, ax:{ intl:[1,0] } },
  { q:{en:'Restaurant and cafe density or everyday shopping?',ja:'飲食店・カフェ密度 or 日常の買い物？'}, ax:{ food:[1,0] } },
  { q:{en:'Fine dining options nearby or simple and local?',ja:'高級飲食店が近い or シンプルでローカル？'}, ax:{ refined:[1,0] } },
  { q:{en:'Green parks or central urban density?',ja:'緑と公園 or 都心の密度？'}, ax:{ green:[1,0] } },
  { q:{en:'Photogenic streets or plain and functional?',ja:'フォトジェニックな街並み or 実用的でシンプル？'}, ax:{ photo:[1,0] } },
  { q:{en:'Active nightlife nearby or early nights?',ja:'夜の選択肢あり or 早寝の街？'}, ax:{ night:[1,0] } },
];
