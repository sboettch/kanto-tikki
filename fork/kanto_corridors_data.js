...
const CORRIDORS_DATA = {
  ...
  toyoko: {
    ...
    pockets: [
      ...
      { id:'pk_hiyoshi', st:'hiyoshi', ward:'kohoku',
        name:{en:'Hiyoshi Ginkgo & Hillside Slopes', ja:'日吉・慶応銀杏並木と本町高台'},
        gem:{en:'Broad golden ginkgo campus boulevard leading to quiet hilltop residential streets in Hiyoshihonchō, with direct Shin-Yokohama and Yokosuka transit connections.',
             ja:'慶應義塾大学の銀杏並木と日吉本町の静穏な高台住宅街。新横浜線や横須賀方面へのアクセスも良好。'},
        noiseWatch:{en:'Noise watch: Afternoon student banter around the station west exit; serene quiet in residential 3-chome.',
                    ja:'騒音注意：駅西口の学生客の賑わい。日吉本町3丁目の住宅街は極めて静穏。'},
        noiseSrc:'Kohoku Ward Community Environment Section',
        photoOp:{en:'Ginkgo boulevard at autumn twilight + hillside vista', ja:'秋の銀杏並木と高台からの眺望'},
        ax:{quiet:4, old:2, intl:3, food:4, craft:3, green:4, night:2, refined:3, photo:4} },
      { id:'pk_musashikosugi', st:'musashikosugi', ward:'nakahara',
        name:{en:'Kosugi River & Grand Tree Plaza', ja:'武蔵小杉・多摩川とグランツリー'},
        gem:{en:'Dynamic riverfront living hub with expansive waterfront levees, modern lifestyle libraries, and seamless multi-line transit.',
             ja:'多摩川の広大な緑地とタワーライフが融合するリバーサイド中枢。'},
        noiseWatch:{en:'Noise watch: Station concourse pedestrian rush at peak hours; riverfront levee blocks are open and breezy.',
                    ja:'騒音注意：通勤ラッシュ時の駅構内混雑。多摩川堤防沿いは開放的で風通し良好。'},
        noiseSrc:'Nakahara Ward Environmental Log',
        photoOp:{en:'Sunset over Tama river levee facing Mount Fuji', ja:'多摩川堤防から富士山を望む夕景'},
        ax:{quiet:3, old:1, intl:4, food:4, craft:2, green:4, night:3, refined:4, photo:3} },
    ],
    homes: [
