...
const POCKETS = [
  { id:'sangenjaya-dt', st:'sangenjaya', en:'Sangenjaya', ja:'三軒茶屋',
    ...
    axes:{quiet:2,old:3,intl:2,food:5,dining:3,craft:3,green:2,photo:3,night:4},
  ...
  { id:'futakotamagawa-dt', st:'futakotamagawa', en:'Futako-Tamagawa', ja:'二子玉川',
    ...
    noiseWatch:null,
    axes:{quiet:2,old:1,intl:3,food:4,dining:5,craft:2,green:5,photo:4,night:3},
  ...
  { id:'mizonokuchi-dt', st:'mizonokuchi', en:'Mizonokuchi', ja:'溝の口',
    ...
    axes:{quiet:2,old:2,intl:1,food:4,dining:3,craft:2,green:2,photo:2,night:3},
    access:{en:'Mizonokuchi, Den-en-toshi + JR Nambu Line.',ja:'溝の口駅（東急田園都市線・JR南武線）。'} },
];
const PKQ = [
  { q:{en:'Quiet street or active neighbourhood?',ja:'静かな街 or 活気ある街？'}, axes:{quiet:[1,0]} },
  { q:{en:'Old-town feel or modern residential?',ja:'昔ながらの雰囲気 or 現代的な住宅地？'}, axes:{old:[1,0]} },
  { q:{en:'International or local Japanese?',ja:'国際的 or 地元の日本らしさ？'}, axes:{intl:[1,0]} },
  { q:{en:'Lots of restaurants and cafes or everyday shopping?',ja:'飲食店・カフェ多い or 日常の買い物重視？'}, axes:{food:[1,0]} },
  { q:{en:'Fine dining or practical and affordable?',ja:'高級飲食店 or リーズナブルで実用的？'}, axes:{dining:[1,0]} },
  { q:{en:'Parks and green space or urban convenience?',ja:'公園・緑 or 都市の利便性？'}, axes:{green:[1,0]} },
  { q:{en:'Photogenic streets or plain and functional?',ja:'映える街並み or シンプルで実用的？'}, axes:{photo:[1,0]} },
  { q:{en:'Evening options nearby or early nights?',ja:'夜の選択肢あり or 早寝？'}, axes:{night:[1,0]} },
];
